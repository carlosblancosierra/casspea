...
def faqs_page(request):
    faqs = [
        ...
        {"question": "How long would a bespoke order take?",
         "answer": "We can make things happen very quickly. If we have the flavor and decoration settled, we can produce them in 3-5 days."},
...
def email_test_page(request):
    ...
    return render(request, "emails/newsletter_subscription.html", context)
